export default {
  ...
  tags: ` ${"" /* dropdown, taglist */}
    ...
    items-center
    w-full
    -mb-$spacing(-2) ${"" /** pull everything up equal to the bottom margin on our tags for consistent spacing */}
    empty:mb-0
  `,
  tagWrapper: ` ${"" /* dropdown, taglist */}
    group/tag ${"" /** important for styling tag-specific instance of removeSelection */}
    mr-$spacing(-2)
    mb-$spacing(-2)
    outline-none
  ...
  `,
  dropdownWrapper: `
    $radius(0,rounded-none,rounded-2xl) ${"" /** don't allow dropdown listbox to go full rounded */}
    empty:hidden
    border
    border-$colorTemperature-$colorTemperatureStrength
    dark:border-$colorTemperature-$colorTemperatureStrengthDark
  ...
  listbox: `
    bg-white
    $radius(0,rounded-none,rounded-2xl) ${"" /** don't allow dropdown to go full rounded */}
    overflow-clip
    empty:hidden
