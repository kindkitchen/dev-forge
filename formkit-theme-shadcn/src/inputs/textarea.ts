export default {
  ...
  input: `
    ...
    grow
    shrink
    !py-$spacing ${"" /** We want spacing on this input because it has a native UI drag handle */}
    !px-$spacing(3) ${"" /** We want spacing on this input because it has a native UI drag handle */}
    outline-none
    bg-transparent
