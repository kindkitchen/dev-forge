export default {
  ...
  inner: `
    relative 
    !border-none ${"" /**  You probably don't want a border around the whole range slider */}
    !ring-0 ${"" /** You probably don't want a focus ring around the whole range slider — just the UI control */}
    !px-0 ${"" /** we're going to want our range input track to go edge to edge */}
    !bg-transparent ${"" /** if you end up adding a background to family:text you likely won't want it here */}
  `,
  input: `
    ${"" /* webkit styles - track */}
