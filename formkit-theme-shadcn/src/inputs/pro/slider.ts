export default {
  ...
  track: `
    ...
    z-20
    py-$spacing(1)
    select-none ${"" /** since users click on the track a lot it's nice to disable accidental text selection */}
  `,
  chart: `
    relative
    w-full
  ...
  fill: `
    ...
    absolute
    top-0
    -mx-1 ${"" /** pull the track highlight back out equal to the wrapper padding */}
