export default {
  ...
  outer: `
    max-w-none ${"" /** allow the transferlist to grow to fit its container because it's a wide input by definition */}
  ...
  transferlist: `
    ...
    min-w-0
    aspect-[4/5]
    h-[350px] ${"" /** even with an aspect ration defined, safari won't cap the height without an explicit value */}
    overflow-hidden
    flex
    flex-col
    border
    ...
    select-none ${"" /** prevent text selection on the transferlist — probably want to do this because it supports drag-and-drop */}
  ...
  sourceSearchClear: ``,
  sourceListItems: `
    group-data-[is-max=true]:opacity-50 ${"" /** similar to disabled styles — indicate when users cannot transfer any more items */}
  `,
  sourceListItem: ``,
  sourceOption: ``,
  sourceEmptyMessage: `
