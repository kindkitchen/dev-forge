export default {
  ...
  outer: `
    max-w-none ${"" /** because the label for a standard toggle is adjacent to the toggle UI, we probably want to allow a wider max width */}
  `,
  wrapper: `
    flex
    flex-wrap
  ...
  innerLabel: `
    ...
    -translate-x-full
    -translate-y-1/2
    px-1 ${"" /** keeps the inner label from touching the absolute edge of the input inner */}
  ...
  `,
  label: `
    peer-first:mb-0 ${"" /** if this is a standard toggle (without an alt label) then we probably want to override our global margin bottom on labels */}
  `,
  help: ``,
  messages: ``,
  message: ``,
